...
int getRSAPublicKeyHSM( JP11_CTX *pCTX, long hObject, BIN *pPubKey )
{
    ...
    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_PUBLIC_EXPONENT, &binPubExp );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_MODULUS, &binModules );
    if( ret != CKR_OK ) goto end;
...
int getECPublicKeyHSM( JP11_CTX *pCTX, long hObject, BIN *pPubKey )
{
    ...
    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_EC_PARAMS, &binParam );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_EC_POINT, &binPoint );
    if( ret != CKR_OK ) goto end;
...
int getDSAPublicKeyHSM( JP11_CTX *pCTX, long hObject, BIN *pPubKey )
{
    ...
    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_PRIME, &binP );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_SUBPRIME, &binQ );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_BASE, &binG );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_VALUE, &binVal );
    if( ret != 0 ) goto end;
...
int getPublicKeyHSM( JP11_CTX *pCTX, long hObject, BIN *pPubKey )
{
    ...
    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_KEY_TYPE, &binVal );
    if( ret != 0 ) goto end;
...
int getRSAPrivateKeyHSM( JP11_CTX *pCTX, long hObject, BIN *pPriKey )
{
    ...
    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_PUBLIC_EXPONENT, &binE );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_MODULUS, &binN );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_PRIVATE_EXPONENT, &binD );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_PRIME_1, &binP );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_PRIME_2, &binQ );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_EXPONENT_1, &binDMP1 );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_EXPONENT_2, &binDMQ1 );
    if( ret != CKR_OK ) goto end;

    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_COEFFICIENT, &binIQMP );
    if( ret != CKR_OK ) goto end;
...
int getECPrivateKeyHSM( JP11_CTX *pCTX, long hObject, BIN *pPriKey )
{
    ...
    ret = JS_PKCS11_GetAttributeValue2( pCTX, hObject, CKA_VALUE, &binValue );
    if( ret != CKR_OK ) goto end;
