...
const QString kModalessStyle = "QDialog { background:#F0FFF0; }";
...
#define ACT_TOOL_DECODE_DATA        VIEW_TOOL | 0x00000001
#define ACT_TOOL_DATA_CONVERTER     VIEW_TOOL | 0x00000002
#define ACT_TOOL_NUM_CONVERTER      VIEW_TOOL | 0x00000004
#define ACT_TOOL_OID_INFO           VIEW_TOOL | 0x00000008
...
#define ACT_TOOL_BIN_VIEW           VIEW_TOOL | 0x00000100
#define ACT_TOOL_TEXT_VIEW          VIEW_TOOL | 0x00000200
...
#define ACT_CRYPT_MAKE_PRI          VIEW_CRYPT | 0x00002000
...
#define ACT_SERVICE_PDF_SIGNER      VIEW_SERVICE | 0x00000080
